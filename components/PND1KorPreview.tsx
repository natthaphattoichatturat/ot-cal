...
import { PND1KorData } from '@/types/documents'
...
const PND1KorPreview = forwardRef<HTMLDivElement, PND1KorPreviewProps>(({ data }, ref) => {
  const commonStyles = {
  ...
  return (
    ...
    >
      ...
      <div style={{ marginBottom: '10px', fontSize: '13px' }}>
        ขอยื่นรายการแสดงการจ่ายเงินได้พึงประเมินตามมาตรา 40 (1) (2) ในปีที่ล่วงมาแล้ว
      </div>
