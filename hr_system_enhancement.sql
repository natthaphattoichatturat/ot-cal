-- ============================================
-- HR System Enhancement - Database Schema
...
CREATE TABLE IF NOT EXISTS public.tax_calculations (
  ...
  CONSTRAINT tax_unique_period UNIQUE (employee_id, year, month, period)
);
...
CREATE TABLE IF NOT EXISTS public.leave_approvals (
  id SERIAL PRIMARY KEY,
  leave_id INTEGER NOT NULL REFERENCES leave(id) ON DELETE CASCADE,
...
-- 2. tax_calculations - คำนวณภาษีแต่ละงวด
